...
public class CreateRecipeRequest
{
    ...
    /// </summary>
    [Required]
    public string Instructions { get; [UsedImplicitly] set; } = string.Empty;
    ...
    /// <summary>
    /// Tags to associate with the recipe.
    /// </summary>
    public List<TagRequest>? Tags { get; [UsedImplicitly] set; }

    /// <summary>
    /// Equipment names needed for the recipe.
    /// </summary>
    public List<string>? EquipmentNames { get; [UsedImplicitly] set; }
}

/// <summary>
/// Request to create or reference a tag.
/// </summary>
public class TagRequest
{
    ...
    /// </summary>
    [Required]
    public TagType TagType { get; [UsedImplicitly] set; }
}
