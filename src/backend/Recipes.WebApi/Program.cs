...
using Recipes.Infrastructure.Identity.Extensions;
using Recipes.WebApi.Extensions;
using Recipes.WebApi.Features.OpenApi.Extensions;
using Recipes.WebApi.Middlewares;
using Serilog;
using LoggerConfigurationExtensions = Recipes.Infrastructure.Logging.Extensions.LoggerConfigurationExtensions;
